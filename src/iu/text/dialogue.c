...
const text_src_t text_array[] = {
    ...
    {TEXT_MAIN2_START3, "I don't care get me this planks ! You've nothing better to do anyways. Try to kill the house to get the planks"},
    ...
    {TEXT_MAIN3_START2, "There is s starnge creature in my beautifull world And i want her to die ! And you'll do it for me !"},
