...
void rtx_triangle_destroy(rtx_triangle triangle)
{
    ...
    if (triangle.root != NULL) {
        ...
        (ref_vec->triangle[triangle.root_ndx].root == ref_vec))
            ref_vec->triangle[triangle.root_ndx].root_ndx = triangle.root_ndx;
        if ((ref_vec->count > 0) &&
        (ref_vec->triangle[triangle.root_ndx].indirect != NULL))
            *ref_vec->triangle[triangle.root_ndx].indirect =
            &ref_vec->triangle[triangle.root_ndx];
